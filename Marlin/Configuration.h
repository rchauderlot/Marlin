...
#define STRING_CONFIG_H_AUTHOR "Roberto Chauderlot" //"(none, default config)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Neo is starting" //WEBSITE_URL         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Neo"
 ...
 */
#define TEMP_SENSOR_0 5 // I cant figure out wich thermistor is included, aliexpress only mentions NTC, but the original E6 includes this one. https://e3d-online.com/100k-ohm-ntc-thermistor-semitec
#define TEMP_SENSOR_1 0
#define TEMP_SENSOR_2 0
#define TEMP_SENSOR_3 0
#define TEMP_SENSOR_4 0
#define TEMP_SENSOR_BED 11 // Heated bed: Orballo printing's MK42 came with a Thermistor NTC 3950 (TEMP_SENSOR 11 firmware Marlin)
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // RCH: Values obtained by executing m301 e0
  #define DEFAULT_Kp 28.49
  #define DEFAULT_Ki 2.59
  #define DEFAULT_Kd 78.22
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // RCH: obtained via "M303 E-1" command
...
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 160, 8070.6, 291.5 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 35 //( 35 - X_PROBE_OFFSET_FROM_EXTRUDER) - X_MIN_POS // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 7 //(  7 - Y_PROBE_OFFSET_FROM_EXTRUDER) - Y_MIN_POS // Y point for Z homing when homing all axes (G28).
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (50*60)
#define HOMING_FEEDRATE_Z  (3*60) // (4*60) // RCH: Reducing this as it is 50 times the max feed rate for Z
