 ...
 *
 * This program is free software: you can MIN_PROBE_EDGEredistribute it and/or modify
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z 100 // RCH: Babysteps are very small. Increase for faster motion.
 ...
 */
  ...
  //  |___________________|
  //     35    136,5   238
  #define PROBING_MARGIN_LEFT   10 + PROBING_MARGIN // Measurement from border to mark in the bed: 35
  #define PROBING_MARGIN_RIGHT  10 + PROBING_MARGIN // Measurement from border to mark in the bed: 238
  #define PROBING_MARGIN_FRONT  PROBING_MARGIN // Measurement from border to mark in the bed: 7
  #define PROBING_MARGIN_BACK   PROBING_MARGIN // Measurement from border to mark in the bed: 203
#endif
 ...
 */
   ...
   */
  // RCH: disabling sensorless homing as Im moving from the tmc2130 divers to the closed loop s42b
